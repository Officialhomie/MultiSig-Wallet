...
contract MultiSigWallet {
    ...
    modifier onlyInEmergency { require(stopped, "Not in emergency"); _; }
    ...
    function canExecuteTransaction(uint256 _txIndex)
        public
        view
        returns (bool)
    {
        Transaction storage transaction = transactions[_txIndex];
        return !transaction.executed && transaction.numConfirmations >= numConfirmationsRequired;
    }
