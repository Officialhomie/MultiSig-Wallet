...
const GetTransactionDetails: React.FC = () => {
  ...
  return (
    <div className="w-[90%] mx-auto border border-b-red my-[30px] h-auto rounded-[10px] p-[15px] flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center gap-[20px] px-[15px] md:px-[50px] py-[15px] h-auto w-[95%] rounded-lg border mt-[20px]">
        {isLoading ? (
          <p>Loading...</p>
        ) : error ? (
          <p style={{ color: 'red' }}>Error: {error}</p>
          ...
          <ul className="list-disc">
            <li>
              <strong>To:</strong>
              <span className="block sm:hidden">{formatAddress(transactionData.to)}</span>
              <span className="hidden sm:block">{transactionData.to}</span>
            </li>
            <li><strong>Value:</strong> {transactionData.value.toString()}</li>
            <li><strong>Data:</strong> {transactionData.data}</li>
            <li><strong>Executed:</strong> {transactionData.executed ? 'Yes' : 'No'}</li>
